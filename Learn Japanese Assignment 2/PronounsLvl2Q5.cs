...
{
    public partial class PronounsLvl2Q5 : Form
    {
        public static PronounsLvl2Q5 instance;
        public bool correct = false;
        public PronounsLvl2Q5()
        {
            InitializeComponent();
            instance = this;
        }
        ...
        {
            if (textBox1.Text == "What" || textBox1.Text == "what")
            {
        ...
        private int Score()
        {
            ...
            if (PronounsLvl2Q1.instance.correct == true)
            {
                counter++;
            }

            if (PronounsLvl2Q2.instance.correct == true)
            {
                counter++;
            }

            if (PronounsLvl2Q3.instance.correct == true)
            {
                counter++;
            }
            if (PronounsLvl2Q4.instance.correct == true)
            {
                counter++;
            }
            if (correct == true)
